 ...
 * --- Generated at Jan 16, 2020 7:23:14 PM                     ---
 * ----------------------------------------------------------------
 */
...
import my.bookstore.core.jalo.EBook;
...
public abstract class GeneratedBookstoreCoreManager extends Extension
{
	...
	**/
	...
	public EBook createEBook(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( BookstoreCoreConstants.TC.EBOOK );
